...
from Tryout import graph_creator_regular_next_one, complicated_edge_intersect_checker_no_change


def shattering_of_four_regular_graphs_no_change(n, degree):
